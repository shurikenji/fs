...
log "Deploy proxy-gateway from ref $RESOLVED_REF"
deploy_release "$RELEASE_DIR" "$PREVIOUS_RELEASE" prepare_proxy_gateway_release
log "Deploy proxy-gateway succeeded: $RELEASE_DIR"
